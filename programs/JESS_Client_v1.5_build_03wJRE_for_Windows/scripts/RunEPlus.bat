...
rem IF NOT EXIST expandedidf.err  "%program_path%%program_name%"
rem === Command to call JESS client instead ===
IF NOT EXIST expandedidf.err  java -jar "%program_path%JESS_Client/JESS_Client.jar" -cfg "%program_path%JESS_Client/client.cfg" -log "%program_path%JESS_Client/log4j.cfg" -job ./ -type STD_SINGLE_JOB -output ./
